...
use \Brainvire\StoreLocator\Model\ResourceModel\Store as ResourceModel;
...
class Store extends AbstractModel implements StoreInterface, IdentityInterface
{
    ...
    const CACHE_TAG = 'brainvire_storelocator_store';
    ...
    public function __construct(
        ...
        $this->_cacheTag = 'brainvire_storelocator_store';
        $this->_eventPrefix = 'brainvire_storelocator_store';
