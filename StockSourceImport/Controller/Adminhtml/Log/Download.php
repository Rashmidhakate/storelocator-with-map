...
class Download extends \Magento\Backend\App\Action
{
    ...
    const IMPORT_HISTORY_DIR = 'stocksourceimport/upload';
    /**
    ...
    public function __construct(
        ...
        $this->pubDirectory = $filesystem->getDirectoryWrite(DirectoryList::MEDIA);
    }
    ...
    {
        $fileName = basename($this->getRequest()->getParam('csv'));
        if (!$this->importFileExists($fileName)) {
             /** @var \Magento\Backend\Model\View\Result\Redirect $resultRedirect */
            $resultRedirect = $this->resultRedirectFactory->create();
            $resultRedirect->setPath('sourceimportlog/log/index');
    ...
    protected function getFilePath($filename)
    {
        ...
        return $this->pubDirectory->getRelativePath('stocksourceimport/upload/' . $filename);
    }
